        ...
        <section className={styles.services}>
          ...
          <div className={styles.servicesContainer}>
            <Service
              ...
              description={
                "توفر شركة  بلو تانك العديد من انواع خزانات المياه وتنكات المياه ومن ضمنها خزانات البولي ايثيلين وهو من أفضل الماركات في مصر حيث أن مادة البولي ايثيلين مصرح بها من قبل الاتحاد الأوروبي ومنظمة الغذاء الأمريكية الصحية والمركز القومي للبحوث"
              }
              dirctUrl={"/services/service1"}
              serviceImg={"/serviceoneNewImg.jpg"}
            />
